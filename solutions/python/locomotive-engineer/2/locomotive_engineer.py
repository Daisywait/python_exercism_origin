...
def add_missing_stops(route,**stops):
    ...
    """
    stops_ordered = [city for key,city in sorted(stops.items(),key = lambda kv:int(kv[0].split("_")[1]))]
    route["stops"] = stops_ordered
    return route
...
def extend_route_information(route, more_route_information):
    ...
    """
    full_route_information = {**route,**more_route_information}
    return full_route_information
